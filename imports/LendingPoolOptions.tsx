...
export default function LendingPoolOptions() {
  return (
    <div className="bg-[rgba(0,0,0,0.01)] content-stretch flex flex-col gap-12 items-center justify-start relative size-full" data-name="lending pool options">
      <HeaderCtaGroup />
      <Group2380 />
    </div>
  );
