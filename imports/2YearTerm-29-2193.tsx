import { img, imgUsdc, imgUsdCoinUsdcLogo1, imgLine129, imgVector, imgKydToken, imgLine244 } from "./svg-hm2bp";
    ...
    <div className="bg-white relative rounded-[16px] shrink-0 w-full" data-name="deposit input and coin select">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex items-center justify-between p-[24px] relative w-full">
          <div className="flex flex-col font-['ABC_Diatype_Unlicensed_Trial:Bold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#333333] text-[32px] text-nowrap">
            <p className="leading-[1.2] whitespace-pre">1,000,000</p>
          </div>
          <CoinSelectMax />
        </div>
      </div>
...
function Commit2Years() {
  return (
    <div className="bg-[#d3f227] box-border content-stretch flex flex-col gap-2 h-[105px] items-start justify-start p-[24px] relative rounded-[16px] shrink-0 w-[194.667px]" data-name="commit 2 years">
      <div aria-hidden="true" className="absolute border border-[#c0dc26] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_2px_10px_-5px_rgba(0,0,0,0.07)]" />
      <div className="flex flex-col font-['ABC_Diatype_Mono_Unlicensed_Trial:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-nowrap tracking-[-0.48px]">
        <p className="leading-[1.2] whitespace-pre">Commit 2 Years</p>
      </div>
      <div className="flex flex-col font-['ABC_Diatype_Unlicensed_Trial:Bold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[25px] text-black text-nowrap">
        <p className="leading-[1.2] whitespace-pre">1x $KYD</p>
      </div>
    </div>
  );
}
...
function Commit3Years() {
  return (
    <div className="bg-[rgba(211,242,39,0.5)] box-border content-stretch flex flex-col gap-2 h-[105px] items-start justify-start leading-[0] not-italic p-[24px] relative rounded-[16px] shrink-0 text-[rgba(51,51,51,0.61)] text-nowrap w-[194.667px]" data-name="commit 3 years">
...
function Commit4Years() {
  return (
    <div className="bg-[rgba(211,242,39,0.5)] box-border content-stretch flex flex-col gap-2 h-[105px] items-start justify-start leading-[0] not-italic p-[24px] relative rounded-[16px] shrink-0 text-[rgba(51,51,51,0.61)] text-nowrap w-[194.667px]" data-name="commit 4 years">
      <div className="flex flex-col font-['ABC_Diatype_Mono_Unlicensed_Trial:Regular',_sans-serif] justify-center relative shrink-0 text-[16px] tracking-[-0.48px]">
...
function KydTokenAmount() {
  return (
    <div className="content-stretch flex gap-2.5 items-center justify-center relative shrink-0" data-name="kyd token amount">
      <KydToken />
      <div className="flex flex-col font-['ABC_Diatype_Unlicensed_Trial:Bold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#333333] text-[25px] text-nowrap">
        <p className="leading-[1.2] whitespace-pre">50,000</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 content-stretch flex flex-col gap-3 grow items-start justify-start min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="expected KYD yield">
      <div className="flex flex-col font-['ABC_Diatype_Mono_Unlicensed_Trial:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#333333] text-[16px] text-nowrap tracking-[-0.8px]">
        <p className="leading-[1.2] whitespace-pre">Expected $KYD • 2 Years</p>
      </div>
      <KydTokenAmount />
    </div>
  );
...
function UsdcAmount() {
  return (
    <div className="content-stretch flex gap-2.5 items-center justify-center relative shrink-0" data-name="USDC amount">
      <div className="flex flex-col font-['ABC_Diatype_Unlicensed_Trial:Bold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#333333] text-[25px] text-nowrap">
        <p className="leading-[1.2] whitespace-pre">210,000</p>
      </div>
      <UsdcLogo />
    </div>
  );
...
function ReviewCta() {
  return (
    <div className="basis-0 bg-[rgba(79,129,201,0.24)] grow min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="review cta">
...
export default function Component2YearTerm() {
  return (
    <div className="bg-neutral-50 relative rounded-[32px] size-full" data-name="2 year term">
